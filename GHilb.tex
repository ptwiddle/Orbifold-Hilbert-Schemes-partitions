...
\subsection{Structure in the Topology of \texorpdfstring{$\Hilb_n(S)$}{Hilb_n(S)}}
...
The topology of Hilbert schemes of points on surfaces was found by G\"ottsche.  A key point is that rather than study $\Hilb_n(S)$ for fixed $n$, it is easier to study them for all $n$ at once.





\section{Background: Hilbert schemes of points on \texorpdfstring{$[\C^2/G]$}{[C^2/G]}}
...
\section{Warm-up: Cores, quotients, and the \texorpdfstring{$SL_2$}{SL_2} case}
