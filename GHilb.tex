...
\usetikzlibrary{decorations.pathreplacing} %for large braces
...
When $\Z_r\subset SL_2$, then $\dim_G(\lambda)$ is closely related to the classical combinatorial notion of \emph{cores and quotients} of partitions.  We give a brief indication of this to motivate the next section, which reviews the theory thorougly.
\begin{definition} \label{def:hooklength}
  Let $\lambda$ be a partition, and $\square\in\lambda$ a cell.  The \emph{hook length} of $\square$, written $h(\square)$ is
$$h=a(\square)+\ell(\square)+1$$
\end{definition}
...
$$\left\{(e, e-k)\big | e\in\Z_{1/2}, k>0\right\}$$ of a filled energy level $e$ and an unfilled energy level $e-k$.    The arm $a(\square)$ corresponds to the number of energy levels between $e$ and $e-k$ that are empty; the leg $\ell(\square)$ is the number of energy levels between $e$ and $e-k$ that are full.  The hook length $h(\square)$ of the corresponding cell is $k$; this is illustrated in the picture below.
\begin{center}
...
\end{scope}
\begin{scope}[rotate=45, very thick, scale=.6*1.412]
   \draw (0,5.5) -- (0, 3) -- (2,3) -- (2,2) -- (3,2) -- (3,0) -- (5.5,0);
   \draw (.5,1.5) node {$s$};
   \draw (.5,2.5) node {$a$};
      \draw (2.5,1.5) node {$\ell$};
      \draw (1.5,1.5) node {$\ell$};
\end{scope}
\begin{scope}[scale=.6]
\node (hand) at  (-5,3.5) {$h$};
\draw[->, dashed] (hand) to (-2.5,3.5);
\node (foot) at (6,4.5) {$f$};
\draw[->, dashed] (foot) to (1.5,4.5);
\end{scope}
...
\begin{scope}[gray, very thin, scale=.6]
   \clip (-5.5, 5.5) rectangle (5.5, -1);
   \draw[rotate=45, scale=1.412, fill, red!20!white] (0,3)--(2,3)--(2,2)--(3,2)--(3,1)--(1,1)--(1,2)--(0,2)--cycle;
   \draw[rotate=45, scale=1.412] (0,0) grid (6,6); 
\end{scope}
\begin{scope}[rotate=45, very thick, scale=.6*1.412]
   \draw (0,5.5) -- (0, 3) -- (2,3) -- (2,2) -- (3,2) -- (3,0) -- (5.5,0);
...
\begin{scope}[xshift=8cm]
   ...
   \end{scope}
   \begin{scope}[rotate=45, very thick, scale=.6*1.412]
      \draw (0,5.5) -- (0, 2) -- (1,2) -- (1,1) -- (3,1) -- (3,0) -- (5.5,0);
   \end{scope}
   \begin{scope}[scale=.6, yshift=-.5cm]
      \draw (-5.5,0) node{$\cdots$};
      \draw (-4.5,0) circle (.3);
...
\begin{scope}[yshift=-7cm] %drawing of the core
...
\begin{scope}[yshift=-11cm] %the quotients

   \begin{scope}[xshift=-4cm] %blue quotient


\draw (0,2) node{$\quot_3^0(\lambda)=2+1$};
      \begin{scope}[gray, very thin, scale=.4]
...
\draw (0,2) node{$\quot_3^1(\lambda)=\emptyset$};
      \begin{scope}[gray, very thin, scale=.4]
         \clip (-5, 3.5) rectangle (5, -1);
         \draw[rotate=45, scale=1.412] (0,0) grid (4,4);
      \end{scope}
...
\draw (0,2) node{$\quot_3^2(\lambda)=1+1$};
...
Using this description, we can get an intuitive picture of what a typical $r$-core looks like that will be very useful when we turn to generalized cores.  The following 4-core is useful for the ensuing discussion.
  ...
  \begin{tikzpicture}[scale=.3]
\draw[very thin, gray!20!white] (0,0) grid (31,25);
\draw[thick] (0,23)--(1,23)--(1,20)--(2,20)--(2,17)--(3,17)--(3,14)--(5,14)--(5,12)--(7,12)--(7,10)--(9,10)--(9,8)--(11,8)--(11,6)--(14,6)--(14,5)--(17,5)--(17,4)--(20,4)--(20,3)--(23,3)--(23,2)--(26,2)--(26,1)--(29,1)--(29,0);
\draw[decorate, decoration={brace, amplitude=5pt}] (1,24)--(4,15) node [midway, right, xshift=3pt, yshift=3pt] {$A$};
\draw[decorate, decoration={brace, amplitude=5pt}] (4,15)--(12,7) node [midway, above, xshift=7pt, yshift=3pt] {$B$};
\draw[decorate, decoration={brace, amplitude=5pt}] (12,7)--(30,1) node [midway, above, xshift=5pt, yshift=4pt] {$C$};

\draw[dashed] (0,14)--(3,14)--(3,0);
\draw[dashed] (0,6)--(11,6)--(11,0);
\draw (1.5, 16) node {$1$};
\draw (1.5, 10) node {$2$};
\draw (1.5, 3) node {$3$};
\draw (6.5, 10) node {$4$};
