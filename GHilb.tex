...
\begin{theorem}[Ellingsrud and Str\o mme \cite{ES}] \labl{thm:ES}
...
If $r=2$, we must have $k=1$, the nontrivial element of $G=\Z/2\Z$ acts as multiplication by -1, andso the points of $\Hilb_2(\C^2)^G$ consisting of distinct points is exactly the sets $\{p,-p}$
